...
public class CreateUserResultModel implements KvmSerializable {
    ...
    public CreateUserResultModel(){}
    
    public CreateUserResultModel(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("CreateUserStatus"))
        {
            Object obj = soapObject.getProperty("CreateUserStatus");
            if (obj!= null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive)obj;
                createUserStatus = CreateUserStatus.fromString(j.toString());
            }
        }
    ...
    public Object getProperty(int arg0) {
        switch(arg0){
            case 0:
                return null;
            case 1:
                return createUserStatus.toString();
            case 2:
                return success;
            case 3:
                return user;
