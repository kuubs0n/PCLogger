...
public class DiscountPeriodModel implements KvmSerializable {
    
    public int maxPeriodDays;
    public int minPeriodDays;
    ...
    public DiscountPeriodModel(){}
    
    public DiscountPeriodModel(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject.hasProperty("MaxPeriodDays"))
        {
            Object obj = soapObject.getProperty("MaxPeriodDays");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                maxPeriodDays = Integer.parseInt(j.toString());
            }else if (obj!= null && obj instanceof Number){
                maxPeriodDays = (Integer) obj;
            }
        }
        if (soapObject.hasProperty("MinPeriodDays"))
        {
            Object obj = soapObject.getProperty("MinPeriodDays");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                minPeriodDays = Integer.parseInt(j.toString());
            }else if (obj!= null && obj instanceof Number){
                minPeriodDays = (Integer) obj;
            }
        }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        switch(index){
            case 0:
                ...
                info.name = "MaxPeriodDays";
                break;
            case 1:
                info.type = PropertyInfo.INTEGER_CLASS;
                info.name = "MinPeriodDays";
                break;
            case 2:
                info.type = null;
