...
public class PurchaseAdditionalDevicesModel implements KvmSerializable {
    ...
    public PurchaseAdditionalDevicesModel(){}
    
    public PurchaseAdditionalDevicesModel(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
